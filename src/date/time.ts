 ...
 * @example
  ...
  const res = timeStampFormat(stamp, 'yyyy-MM-dd hh:mm:ss') // 2020-11-27 08:23:24
  */
 ...
 * @example
  ...
  const res = dateFormat(date, 'yyyy-MM-dd hh:mm:ss') // 2020-11-27 08:23:24
  ```
 */
 ...
 * @example
  ...
  const date = new Date('2020-11-27 8:23:24');
  const res = parseTime(date, 'yyyy-MM-dd hh:mm:ss') // 2020-11-27 08:23:24
  */
 ...
 * @example
  ...
  const res = getTimeAgo(date) // 1个月前

  const date = new Date('2021-11-27 8:23:24').getTime();
  const res = getTimeAgo(date) // 10个月后
  */
 ...
 * @example
 *
 * getCountDownObj(100) // {day: 0, hour: 0, minute: 1, second: 40}
